...
func TestRookAttacksSquares(t *testing.T) {
	...
	expected := bitboardFromCoordinates(expectedSquares)
	got := rookAttacks(Bsf(bitboardFromCoordinate("f8")), pos.Pieces(White)|pos.Pieces(Black))
...
func TestBishopAttacksSquares(t *testing.T) {
	...
	expected := bitboardFromCoordinates(expectedSquares)
	got := bishopAttacks(Bsf(bitboardFromCoordinate("c5")), pos.Pieces(White)|pos.Pieces(Black))
