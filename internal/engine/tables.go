...
var MiddlegamePieceValue = [6]int{10000, 1001, 432, 341, 308, 72}

// EndgamePieceValue is the value of each piece endgame phase
var EndgamePieceValue = [6]int{10000, 1081, 600, 360, 348, 84}

// MiddlegamePSQT are the pieces square tables for middlegame
var MiddlegamePSQT = [6][64]int{
	// King
	{
		-45, 28, 28, -24, -43, -25, 14, 10,
		-14, -1, -30, 19, 2, 2, -6, -17,
		-61, 23, -24, -28, -5, 43, 12, -27,
		-52, -50, -65, -99, -94, -73, -70, -110,
		-67, -43, -72, -101, -102, -70, -82, -135,
		-27, 4, -46, -56, -46, -55, -16, -51,
		47, 5, 0, -26, -33, -13, 14, 31,
		44, 60, 41, -25, 23, -16, 42, 51,
	},
	// Queen
	{
		-28, -32, -15, 6, 11, 28, 55, 1,
		2, -25, -24, -39, -46, 1, 0, 55,
		0, -8, -11, -13, -10, 35, 37, 34,
		-14, -7, -11, -11, -17, -11, -7, -2,
		-4, -13, -11, -9, -9, -18, 0, -1,
		-5, -2, -9, -12, -6, -5, 11, 8,
		4, 0, 3, 5, 3, 14, 25, 38,
		-7, -1, 0, 0, 4, -6, 5, 13,
	...
	// Rook
	{
		0, -3, -5, -11, 7, 30, 36, 44,
		-7, -9, 6, 24, 3, 41, 31, 51,
		-22, 3, -2, -3, 18, 30, 60, 25,
		-24, -10, -10, -2, -1, 6, 12, -3,
		-32, -33, -23, -14, -14, -26, -3, -21,
		-35, -29, -26, -22, -11, -10, 18, -5,
		-31, -28, -16, -13, -8, 0, 15, -18,
		-17, -13, -12, -5, 2, -2, 1, -10,
	},
	// Bishop
	{
		-24, -54, -54, -98, -77, -86, -35, -57,
		-11, 1, -6, -19, -2, -15, -32, -38,
		-1, 0, 3, 8, 1, 33, 13, 11,
		-15, 4, 3, 19, 12, 9, 0, -15,
		1, -12, -3, 17, 15, -5, -4, 17,
		3, 14, 5, 5, 8, 9, 13, 25,
		26, 7, 19, -2, 6, 20, 30, 27,
		13, 24, 1, -3, 5, -2, 18, 43,
	},
	// Knight
	{
		-113, -97, -56, -30, 9, -68, -44, -75,
		0, 10, 35, 42, 16, 67, 5, 22,
		4, 19, 25, 30, 57, 64, 31, 15,
		8, 9, 20, 41, 20, 43, 15, 41,
		1, 5, 7, 17, 19, 19, 18, 11,
		-15, -4, -7, 0, 16, -4, 17, 1,
		-16, -12, -7, 7, 5, 9, 12, 9,
		-48, -11, -24, -11, -4, 0, -9, -8,
	},
	...
	{
		0, 0, 0, 0, 0, 0, 0, 0,
		75, 77, 54, 96, 62, 51, -39, -46,
		21, 10, 42, 49, 58, 91, 55, 25,
		-7, -5, 3, 5, 26, 23, 8, 5,
		-9, -12, 0, 14, 15, 15, 0, -3,
		-14, -7, -4, 2, 14, 3, 16, 0,
		-13, -8, -5, -6, 1, 18, 20, -11,
...
var EndgamePSQT = [6][64]int{
	...
	{
		-80, -41, -25, 5, -1, 3, -2, -86,
		-16, 27, 35, 30, 42, 53, 51, 12,
		4, 32, 50, 60, 63, 58, 56, 21,
		-3, 34, 55, 68, 68, 63, 50, 22,
		-12, 18, 45, 62, 60, 43, 30, 14,
		-24, 0, 24, 38, 36, 24, 1, -10,
		-45, -13, 1, 14, 15, 0, -20, -43,
		-86, -63, -38, -14, -37, -24, -58, -94,
	},
	// Queen
	{
		28, 43, 61, 56, 54, 49, 6, 38,
		20, 49, 78, 101, 124, 85, 66, 55,
		28, 38, 68, 80, 98, 79, 51, 55,
		36, 43, 56, 73, 91, 83, 82, 67,
		19, 43, 44, 63, 62, 62, 47, 51,
		6, 18, 35, 35, 38, 37, 15, 13,
		-4, -6, -3, 1, 8, -14, -42, -57,
		-3, -4, -4, 8, -5, -9, -22, -26,
	},
	// Rook
	{
		46, 50, 57, 53, 44, 41, 40, 37,
		48, 59, 60, 48, 52, 40, 40, 31,
		49, 47, 49, 46, 37, 31, 28, 27,
		51, 46, 51, 45, 35, 30, 34, 33,
		41, 43, 41, 37, 34, 37, 28, 28,
		30, 28, 26, 27, 20, 16, 0, 3,
		20, 24, 23, 20, 12, 8, 0, 6,
		18, 19, 27, 20, 13, 15, 10, 3,
	},
	// Bishop
	{
		3, 9, 4, 15, 10, 2, 0, -5,
	...
	// Knight
	{
		-40, -15, -3, -13, -15, -29, -26, -61,
		-3, -2, -12, -13, -16, -28, -5, -22,
		-6, -10, 2, 4, -8, -20, -17, -15,
		3, 0, 8, 11, 15, 8, 7, -5,
		0, -4, 12, 9, 18, 5, 1, 0,
		-10, -8, -3, 11, 9, -8, -11, -6,
		-6, -3, -10, -10, -11, -14, -13, 8,
		8, -19, -11, -10, -7, -16, -8, 3,
	},
	// Pawn
	{
		0, 0, 0, 0, 0, 0, 0, 0,
		149, 135, 139, 74, 77, 97, 143, 165,
		77, 80, 35, -5, -11, 12, 56, 60,
		59, 46, 30, 10, 9, 17, 34, 33,
		39, 35, 23, 15, 13, 18, 24, 22,
		33, 30, 25, 25, 25, 26, 19, 19,
		35, 32, 28, 26, 36, 27, 19, 18,
		0, 0, 0, 0, 0, 0, 0, 0,
	},
}
