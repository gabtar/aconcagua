...
// Warning; PV continues after threefold repetition - move a4a3 from Aconcagua DEV
// Info; info depth 14 seldepth 23 score cp -60 nodes 65773 nps 2781607 hashfull 16 time 49 pv d7e6 c2d3 e6f7 g2g4 a4a3 d3e4 a3a4 e4d3 a4a5 d3e4 a5a4 e4d3 a4a3 d3c4 a3a5 c4d4 a5b5 d4e4
...
func TestRepetitionBug(t *testing.T) {
	...
	lastHash := pos.positionHistory.previousPosition[pos.positionHistory.moveCount-1]
	...
	fmt.Println("Halfmove clock: ", pos.positionHistory.previousState[pos.positionHistory.moveCount-1].rule50())
	fmt.Println("Move count: ", pos.positionHistory.moveCount)
	count := 0
	for i := range pos.positionHistory.previousPosition {
		if pos.positionHistory.previousPosition[i] == lastHash {
			count++
		}
	}
	fmt.Println("Repetitions: ", count)
